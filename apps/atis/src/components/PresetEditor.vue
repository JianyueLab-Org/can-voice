...
<template>
  <div class="flex flex-col gap-2">
    <label class="flex flex-col gap-1">
      <span class="text-xs opacity-60">{{ t("preset.template") }}</span>
    ...
    <label class="flex flex-col gap-1">
      <span class="text-xs opacity-60">{{ t("preset.airport_conditions") }}</span>
    ...
    <div class="grid grid-cols-2 gap-2">
      ...
      <label class="flex flex-col gap-1">
        <span class="text-xs opacity-60">{{ t("preset.transition_level") }}</span>
        <input
    ...
    <label class="flex flex-col gap-1">
      <span class="text-xs opacity-60">{{ t("preset.closing") }}</span>
      <input
    ...
    <div v-if="chineseShown" class="grid grid-cols-2 gap-2">
      <label class="flex flex-col gap-1">
        <span class="text-xs opacity-60">{{ t("preset.chinese_runway") }}</span>
      ...
      <label class="flex flex-col gap-1">
        <span class="text-xs opacity-60">{{ t("preset.chinese_extra") }}</span>
        <input
